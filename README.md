...
3. Place a PCK file and an optional DLL in the `Content` directory within the workspace. This is what will be uploaded to the Steam workshop.
...
7. Run `ModUploader.exe -w <workspace-folder>` to upload the mod.
